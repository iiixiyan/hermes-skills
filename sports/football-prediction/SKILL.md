...
🎯 异常：[比分1]/[比分2] 🏷️ [A1/B1等] → [胜/平/负] [让球结果]
⭐ XX ★ | 🔗 文彩：[状态]
💰 双选：[比分A] / [比分B]  ➡ 偏重[比分A]
```
...
- ✅ 比分整数，每组2个，不得雷同，逐场发送
- ✅ **每场必须输出让球胜平负结果**（让球数从59itou列表页(±N)提取，推导规则见references/analysis-framework.md §8）
...
| 版本 | 日期 | 变更 |
|:----|:----|:-----|
| v4.4.1 | 2026-05-27 | **新增让球胜平负强制输出**：每场比分预测后自动推导让球结果（含让球数提取+计算规则）；更新输出格式含⚽让球[±N]；cron任务输出5串1增加让球方向 |
