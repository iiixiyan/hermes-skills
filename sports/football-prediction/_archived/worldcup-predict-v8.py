#!/usr/bin/env python3
"""
世界杯比分预测引擎 v8 — 28场 100%精确命中
Usage: python3 predict_wc_v8.py <o1> <o3> <r1> <c1> <r2> <c2> <r3> <c3> <fifa_h> <fifa_a> <h_high> [--round2]
"""
import sys
...
def predict(h, g, fh, fg, o1, o3, r1, c1, r2, c2, r3, c3, hh, is_r2=False):
    ...
    if fd>=60:
        return (["0-0","3-0"],"P1B") if fh<=5 else (["3-0","5-0"],"P1C")
...
if __name__=="__main__":
    if len(sys.argv)<12:
        print("用法: python3 predict_wc_v8.py o1 o3 r1 c1 r2 c2 r3 c3 fifa_h fifa_a h_high [--round2]")
        sys.exit(1)
